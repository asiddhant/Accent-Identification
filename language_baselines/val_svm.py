...
param_grid = dict(C=[1,5,10],gamma=[0.1,0.5,1,2])

grid = GridSearchCV(estimator=clf, param_grid=param_grid, cv=pdcv, n_jobs=6)
grid_result = grid.fit(data_x,data_y)

f1=open('/home/aditya/Desktop/accent_identification/language_baselines/logfiles/svm.txt', 'a+')
...
pickle.dump(grid,open("/home/aditya/Desktop/accent_identification/language_baselines/models/svm.p","wb"))
