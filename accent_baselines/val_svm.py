...
f1=open('/home/aditya/Desktop/accent_identification/accent_baselines/logfiles/svm.txt', 'a+')
...
pickle.dump(grid,open("/home/aditya/Desktop/accent_identification/accent_baselines/models/svm.p","wb"))
