...
f1=open('/home/aditya/Desktop/accent_identification/accent_baselines/logfiles/lda.txt', 'a+')
...
pickle.dump(grid,open("/home/aditya/Desktop/accent_identification/accent_baselines/models/lda.p","wb"))
